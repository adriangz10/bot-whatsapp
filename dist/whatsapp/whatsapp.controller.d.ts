...
export declare class WhatsAppController {
    ...
    constructor(whatsappService: WhatsAppService, geminiService: GeminiService, configService: ConfigService, chatsService: ChatsService, googleSheetsService: GoogleSheetsService, conversationService: ConversationService);
